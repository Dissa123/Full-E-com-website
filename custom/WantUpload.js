...
function WantUpload() {
    ...
    const handleOpenPicker = () => {
        openPicker({
          ...
          viewId: "DOCS",
          token:"ya29.a0ARrdaM8k1CNkFZJoBidHENwqz_92SJu01voDsGeM0k7JYPjDYF9j_-SWVWkKpi1GAox8S22NiOyieO9bbz66DJkiTd8Bys3HMCclWimMJzZms_XlKOYdFmTBCQ8IDeecHNoOdwooCbO_WbP59HsaVQVuuC9c",          // token: token, // pass oauth token in case you already have one
          showUploadView: true,
      ...
      <div className="container">
        ...
        >
          ...
          <div className="row mt-5" style={{ marginTop: "50%" }}>
            ...
            <div className="col-md-4 gbox">
            <button onClick={() => handleOpenPicker()} className="gBtn">
